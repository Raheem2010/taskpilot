...
async def create_plan(payload: GoalRequest) -> PlanResponse:
    ...
    dummy_milestones = [
        Milestone(
            ...
            description="Cover the core concepts related to your goal.",
        ),
        Milestone(
            title="Practice with small tasks",
            description="Apply what you've learned in practical exercises.",
        ),
    ]
    ...
    return PlanResponse(
        ...
        tasks=dummy_tasks,
        schedule_summary=(
            "This is a placeholder plan. In the full version, this will be "
            "generated by the TaskPilot planning agent."
        ),
    )
